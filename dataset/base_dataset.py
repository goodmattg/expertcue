...
from utils.motion import trans_motion3d, normalize_motion, get_local3d
import os
...
class _MixamoDatasetBase(Dataset):
    ...
    def preprocessing(self, item, view_angle=None, param=None):
        ...
        motion_proj = motion_proj.reshape(
            (-1, motion_proj.shape[-1])
        )  # reshape to (joints*2, len_frames)
